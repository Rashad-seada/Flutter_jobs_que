...
class GetSuggestedJobsUsecase implements Usecase<SuggestedJobsEntity> {
  ...
  @override
  Future<Either<Failure, SuggestedJobsEntity>> call() async {
    return await repo.getSuggestedJobs();
  }
