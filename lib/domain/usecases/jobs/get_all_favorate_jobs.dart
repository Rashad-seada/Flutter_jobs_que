...
import '../../entities/jobs/all_favorite_jobs_entity.dart';

class GetAllFavoriteJobsUsecase implements Usecase<AllFavoriteJobsEntity> {
  ...
  @override
  Future<Either<Failure, AllFavoriteJobsEntity>> call() async {
    return await repo.getFavoriteJobs();
  }
